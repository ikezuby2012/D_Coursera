...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251020210409_createCourseTimeline")]
    partial class createCourseTimeline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Course.CourseTimelineMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tbl_course_timeline_media");

                    b.HasIndex("CourseId")
                        .HasDatabaseName("ix_tbl_course_timeline_media_course_id");

                    b.HasIndex("UploadedById")
                        .HasDatabaseName("ix_tbl_course_timeline_media_uploaded_by_id");

                    b.ToTable("TBL_CourseTimelineMedia", "dbo");
                });
            ...
            modelBuilder.Entity("Domain.Course.CourseTimelineMedia", b =>
                {
                    b.HasOne("Domain.Course.Course", "Course")
                        .WithMany("TimelineMedias")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_course_timeline_media_tbl_courses_course_id");

                    b.HasOne("Domain.Users.User", "UploadedBy")
                        .WithMany()
                        .HasForeignKey("UploadedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_course_timeline_media_tbl_users_uploaded_by_id");
